...
<form action="showUserId" method="post">
...
<div class="container">
    ...
    <input type="email" placeholer="Enter the Email again here" required name="email" value = ${emailvalue} ><br>
    <label for="answer">Security Question<br><br>
    <b>${securityQuestion}</b></label>
    <input type="text" name="answer" required>
      
     <button type="submit" class="green-btn" >Submit</button>
    <br>
    <h2 style = 'color:green;'>${userId} </h2>
    ${errorMsg}
        </div>
    </div>
</form>
