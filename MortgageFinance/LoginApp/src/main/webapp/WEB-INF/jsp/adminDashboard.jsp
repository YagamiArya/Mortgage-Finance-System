...
.grid-container {
    ...
    <body>
        <br><br>
        <form action="logout" onsubmit="return triggerFeedback()" >
        <button type="submit" class="logOutButton"
                onclick="return conformLogout()"
                >Log out</button>
        <h2><b>Welcome Back ${userId} ...</b></h2>
        </form>
        <div class="grid-container">
            <div class="container">
            <a href="addMortgage"><img src="/Files/viewLoanStatus.png" alt="view loan status"><br>
                <h2><b>Add Mortgage</b></h2></a>
            </div>
        ...
        function triggerFeedback(){
            var answer = window.confirm("Would you like to provide Feedback?");
            if (answer) {
                window.location.href = "getFeedback";
                return false;
            }
            else {
                return true;
