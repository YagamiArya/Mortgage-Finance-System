...
<form action="updateFeedback" method="post">
  ...
  <div class="imgcontainer" >
    <img src="/Files/MyLogo.png" alt="Avatar" class="avatar" width="" height="400">
    
  </div>
<div class="container">
	<label for="userId"><b>Enter Your UserId</b></label>
    <input type="text" placeholer="Enter the UserId again here"  name="userId" value = ${userId} ><br>
    <br><br>
    <b>Feedback</b>
    ...
    <br>
    <h2 style = 'color:green;'>${feedbackMsg} </h2>
